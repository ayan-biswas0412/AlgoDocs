...
def dijkstra(current, nodes, distances):
    unvisited = {node: None for node in nodes} #nodes which have not been visited yet
...
- [Dijkstra's algorithm - PythonPool](https://www.pythonpool.com/dijkstras-algorithm-python/)
